A function is a self contained piece of code which has it's own local variables and performs a specified task. Think of them as "mini-scripts" that can be written separately from the main script.
