Throughout this site, instructions for statistical analyses, data management and graphical techniques are provided in the software language R. R is an free, open source language that has rapidly become standard usage in the biological and environmental sciences. Apart from the cost, the language has the benefits of being able to explicitly share methods with colleague, and a very active community of people who are developing packages that will run very many types of analyses and graphics.
<br><br>
...
![](blue-125.png)
<br><br>
We recommend using R Studio as an effective interface for using R.
...
![](Getting_started_R_Studio_image.jpg)
...
Our help modules on [Good practice for writing scripts](http:environmentalcomputing.net/Good-practice-for-writing-scripts/) and [Importing data and data cleaning](http:environmentalcomputing.net/Importing-data-and-data-cleaning/)
