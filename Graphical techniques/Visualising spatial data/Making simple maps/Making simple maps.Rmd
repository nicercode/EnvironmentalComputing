...
Well done -you made your first map with R! Easy! You may have noticed that `ggmap` uses familiar graphics code from the package ggplot (see [plotting with ggplot2](http://environmentalcomputing.net/plotting-with-ggplot/))  
<br><br>
