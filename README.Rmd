...
The most important folders for this website are `content/`,  `static/` and  `public/`.
...
For more info about this directories see [here](https://bookdown.org/yihui/blogdown/hugo.html)
