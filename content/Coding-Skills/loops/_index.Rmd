...
Now we can use your new loop skills in an ecological context. As with the [Subsetting data](http://environmentalcomputing.net/subsetting-data/) tutorial, we will use a dataset where bats were sampled across regrowth forest in south-eastern Australia which has been thinned to reduce the density of trees. 
