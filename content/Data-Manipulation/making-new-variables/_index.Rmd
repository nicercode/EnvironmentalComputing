...
These functions become especially powerful when combined with some of the others in dplyr. See our pages on [subsetting](/../subsetting-data/) and [summarising](/../summarising-data/) data. 
