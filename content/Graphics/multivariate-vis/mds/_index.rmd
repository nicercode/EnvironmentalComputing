...
Your data should be formatted so that each sample is a row and each variable is a column. Download the [herbivore specialisation](/../wp-content/uploads/2016/05/Herbivore_specialisation.csv) data set, and import into R to see the desired format.
