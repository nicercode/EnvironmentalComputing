...
Your data should be formatted with variables as columns and observations as rows. Download the sample leaf shape data set, [Leafshape.csv.](/../wp-content/uploads/2016/05/Leafshape.csv), and import into R to see the required format.
