...
```{r setup, tidy=TRUE, cache=TRUE, message=FALSE, warning=FALSE}
library(metafor)
```
...
```{r effect-size-2, tidy=TRUE, cache=TRUE}
...
```{r, tidy=TRUE, cache=TRUE, message=FALSE, warning=FALSE}
library(dplyr)
...
Once you have calculated effect sizes, move on to the next page: [Meta-analysis 2: fixed-effect and random-effect models](http://environmentalcomputing.net/meta-analysis-2)
