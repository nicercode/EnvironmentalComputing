...
First read our [introduction to meta analysis](/../meta-analysis) with instructions for calculating effect sizes. Now, we consider the statistical models to estimate mean effect sizes and the influence of moderator variables.
...
If you are happy with all this, move on the [more complex models](/../meta-analysis-3)
