...
2. [Mixed models 2](/../mixed-models-2/) extends this to **multiple random effects** with a continuous response. We look into how to model nested and crossed random effects.

3. [Mixed models 3](/../mixed-models-3/) teaches you how to model **discrete data**, including counts and binary data, with random effects.  
