...
You will need to read [Mixed models 1](/../mixed-models-1/) and [Mixed models 2](/../mixed-models-2/) as an introduction to mixed models for continuous data, as well as the help pages on [Generalised linear models](/../generalised-linear-models/) as an introduction to modelling discrete data. 
...
As before you could run hypothesis tests on the random effects using a parametric bootstrap. See [Mixed models 1](/../mixed-models-1/) and [Mixed models 2](/../mixed-models-2/) for code that you could modify for this situation.
