...
You will need to read [Mixed models 1](/statistics/mixed-models/mixed-model-1/) and [Mixed models 2](/statistics/mixed-models/mixed-model-2/) as an introduction to mixed models for continuous data, as well as the help pages on [Generalised linear models](/statistics/glms/generalised-linear-models/) as an introduction to modelling discrete data. 
