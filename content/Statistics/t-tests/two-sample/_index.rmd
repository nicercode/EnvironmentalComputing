...
An independent samples *t*-test can be run with the same `t.test` function as used for [one sample](/../one-sample-t-test/) or [paired *t*-tests](/../paired-t-tests/). For an independent samples *t*-test assuming equal variances, we would use: 
...
Download the sample data set, [River_pH.csv](/../wp-content/uploads/2016/05/River_pH.csv), and import into R.
