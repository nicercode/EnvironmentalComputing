...
* [Install R and learn the basics of using R](http://environmentalcomputing.net/getting-started-with-r/)  
* Think about [project management](http://environmentalcomputing.net/basic-project-management) to plan how you are going to organise your files 
<br>
