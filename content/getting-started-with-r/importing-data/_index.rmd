...
Importing data is a major challenge for beginners. This module will give instructions for one of most common ways we import data, and some of challenges you may face and how to overcome them. Some of these issues can be avoided by following good data entry and management practices (first read [Data entry](/../getting-started-with-r/data-entry/) to get help with this.
...
First, save the data file, [Snail_feeding.csv](/../wp-content/uploads/2016/05/Snail_feeding.csv) to your working directory. See [Getting started with R](/../getting-started-with-r/) for help on for setting the working directory.
...
`str`  enables you to check the structure of your data and that your variables are the correct type (i.e., numeric, characters, integers, or factors). See [Data types and structure](/../Data-types-and-structure/) for explanations of these different types.
...
The package [dplyr](https://cran.r-project.org/web/packages/dplyr/index.html) has several very neat functions for subsetting rows and columns - see [Subsetting data](/../Subsetting-data/) for help with these.
