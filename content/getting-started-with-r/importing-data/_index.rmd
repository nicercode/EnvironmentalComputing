...
First, save the data file, [Snail_feeding.csv](/datasets/Snail_feeding.csv) to your working directory. See [Getting started with R](/../getting-started-with-r/) for help on for setting the working directory.
