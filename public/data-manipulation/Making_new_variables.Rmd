...
![](Making new variables/MDS_image.jpg)

Download the data set, [Herbivore_specialisation.csv](http://environmentalcomputing.net/wp-content/uploads/2016/05/Herbivore_specialisation.csv), and load into R.

```{r}
Herbivores <- read.csv(file = "Making new variables/Herbivore_specialisation.csv", header = TRUE)
```
...
<br>
![](Making new variables/Making_new_variables_image.jpg)
...
These functions become especially powerful when combined with some of the others in dplyr. See our pages on [subsetting](http://environmentalcomputing.net/subsetting-data/) and [summarising](http://environmentalcomputing.net/summarising-data/) data. 
<br><br>
...
<br>
![](Making new variables/Unite_image.jpg)
...
<br>
![](Making new variables/Separate_image.jpg)
