...
Output from your code will appear directly below the code chunk rather than in the console below or the plots pane to the right. For example, a plot of plant height vs temperature from the data set used in our [linear regression tutorial](http://environmentalcomputing.net/linear-regression/).
...
| Inserting a link: More help at Environmental Computing-http://environmentalcomputing.net | More help at [Environmental Computing](http://environmentalcomputing.net)  |
...
Nathan Stephen's [Why I love R notebooks](https://rviews.rstudio.com/2017/03/15/why-i-love-r-)

Jonathan McPherson's [R Notebooks](https://blog.rstudio.com/2016/10/05/r-)
