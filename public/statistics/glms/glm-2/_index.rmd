...
Download the sample data set, [Revegetation.csv](http://environmentalcomputing.net/wp-content/uploads/2016/05/Revegetation.csv), and import into R to see how the data are arranged:
...
More advice on [interpreting coefficients in glms](http://environmentalcomputing.net/interpreting-coefficients-in-glms/)
<br><br>
