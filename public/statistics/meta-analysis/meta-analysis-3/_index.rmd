...
---
First read our [introduction to meta analysis](http://environmentalcomputing.net/meta-analysis-1) and become familiar with [commonly used statistical models for meta-analysis](http://environmentalcomputing.net/meta-analysis-2). Now, we consider more complex models.
...
```{r prep1, tidy=TRUE, cache=TRUE, warning=FALSE}
library(ape)
...
```{r weight, tidy=TRUE, cache=TRUE, echo=FALSE}
